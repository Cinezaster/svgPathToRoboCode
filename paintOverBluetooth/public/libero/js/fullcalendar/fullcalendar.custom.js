...
var defaults = {
	...
	buttonText: {
		prev: "<span class='fc-text-arrow'><i class='icon-chevron-left'></span>",
		next: "<span class='fc-text-arrow'><i class='icon-chevron-right'></span>",
		prevYear: "<span class='fc-text-arrow'><i class='icon-chevron-left'></span>",
		nextYear: "<span class='fc-text-arrow'><i class='icon-chevron-right'></span>",
		today: 'today',
		month: 'month',
		week: 'week',
		day: 'day'
...
function Calendar(element, options, eventSources) {
	...
	function initialRender() {
		...
		element.addClass('fc fc-wrapper');
		if (options.isRTL) {
					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							var button = $(
								...
								.click(function() {
									if (!button.hasClass(tm + ' disabled')) {
										buttonClick();
									}
								})
								.mousedown(function() {
...
function BasicView(element, calendar, viewName) {
	...
	function buildTable(showNumbers) {
		...
		html += "<table class='fc-table table table-bordered'>" +
		        "<thead>" +
		        "<tr>";
...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		s =
			"<table class='fc-table table table-bordered' cellspacing='0'>" +
			"<thead>" +
			"<tr>";
		...
		s =
			"<table class='fc-table table table-bordered fc-agenda-slots'>" +
			"<tbody>";
		d = zeroDate();
